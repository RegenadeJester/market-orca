...
- 5 features/improvements minimum per session
- Use git flow: issue → branch → PR → merge
...
|| 2026-06-24 | 8 | Market Activity Feed API + CI fix (data/ dir) | feat/market-activity-feed | PR #8 open |
